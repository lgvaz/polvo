...
# %% auto 0
__all__ = ['show_tfms', 'DataExplorer', 'FastaiDataExplorer']
...
class DataExplorer:
    def __init__(self, label_ids, id2image, id2label, label2id):
        store_attr()
    ...
    def show_most_common(self, idx: int, slice_=slice(None)):
        ...
        images = [self.id2image(i) for i in item_idxs]
...
# %% ../../nbs/02a_classification.explorer.ipynb 13
class FastaiDataExplorer(DataExplorer):
...
# %% ../../nbs/02a_classification.explorer.ipynb 19
